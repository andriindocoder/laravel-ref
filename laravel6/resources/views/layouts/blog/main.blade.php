...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('laravel_blog/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('laravel_blog/css/custom.css') }}">
</head>
<body>
    <header>
    ...
    <script src="{{ asset('laravel_blog/js/bootstrap.min.js') }}"></script>
</body>
</html>