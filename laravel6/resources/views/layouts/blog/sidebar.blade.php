                ...
                <ul class="popular-posts">
                    <li>
                        <div class="post-image">
                            <a href="#">
                                <img src="{{ asset('laravel_blog/img/Post_Image_5_thumb.jpg') }}" />
                            </a>
                        </div>
                        <div class="post-body">
                    ...
                    <li>
                        <div class="post-image">
                            <a href="#">
                                <img src="{{ asset('laravel_blog/img/Post_Image_4_thumb.jpg') }}" />
                            </a>
                        </div>
                        <div class="post-body">
                    ...
                    <li>
                        <div class="post-image">
                            <a href="#">
                                <img src="{{ asset('laravel_blog/img/Post_Image_3_thumb.jpg') }}" />
                            </a>
                        </div>
                        <div class="post-body">
