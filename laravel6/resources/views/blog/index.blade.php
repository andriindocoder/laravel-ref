            ...
            <div class="col-md-8">
                <article class="post-item">
                    <div class="post-item-image">
                        <a href="post.html">
                            <img src="{{ asset('laravel_blog/img/Post_Image_1.jpg') }}" alt="">
                        </a>
                    </div>
                ...
                <article class="post-item">
                    <div class="post-item-image">
                        <a href="post.html">
                            <img src="{{ asset('laravel_blog/img/Post_Image_2.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-item-body">
                        <div class="padding-10">
                ...
                <article class="post-item">
                    <div class="post-item-image">
                        <a href="post.html">
                            <img src="{{ asset('laravel_blog/img/Post_Image_3.jpg') }}" alt="">
                        </a>
                    </div>
                    <div class="post-item-body">
                        <div class="padding-10">
