<div class="my-10 flex justify-center w-full">
    <section class="border rounded shadow-lg p-4 w-6/12 bg-gray-200">
        <h1 class="text-center text-3x1 my-5" style="font-size: 38px;">Login</h1>
        <hr>
        <form wire:submit.prevent="submit" class="my-4">
            ...
            <div class="flex justify-around my-8">
                <div class="flex flex-wrap w-10/12">
                    <input type="submit" value="Login" class="p-2 bg-gray-800 text-white rounded tracking-wider cursor-pointer w-full" />
                </div>
            </div>
        </form>
    </section>
