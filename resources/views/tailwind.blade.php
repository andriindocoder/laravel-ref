...
<body class="bg-gray-100">
	<div class="px-8 py-12">
		<img class="h-16" src="/img/logo.png" alt="Workcation">
		<img class="mt-6 rounded-lg shadow-xl" src="/img/bnb.jpeg" alt="Workcationing on a beach">
		...
		<div class="mt-4">
			<a href="#" class="inline-block bg-indigo-500 text-sm text-white px-5 py-3 rounded-lg shadow-lg uppercase tracking-wider font-semibold">Book you escape</a>
		</div>
	</div>
</body>
</html>
