	...
	<div class="flex bg-gray-100">
		<div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
			<div class="xl:max-w-lg xl:ml-auto">
				<img class="h-10" src="/img/logo.png" alt="Workcation">
				<img class="mt-6 sm:mt-8 rounded-lg shadow-xl sm:h-64 sm:w-full sm:object-cover sm:object-center lg:hidden" src="/img/bnb.jpeg" alt="Workcationing on a beach">
				...
				<div class="mt-4 sm:mt-6">
					<a href="#" class="inline-block bg-indigo-500 text-sm text-white px-5 py-3 rounded-lg shadow-lg uppercase tracking-wider font-semibold sm:text-base">Book your escape</a>
				</div>
			</div>
		</div>
		<div class="hidden lg:block lg:w-1/2 lg:relative">
			<img class="absolute inset-0 h-full w-full object-cover object-center" src="/img/bnb.jpeg" alt="Workcationing on a beach">
		</div>
	</div>
</body>
</html>
